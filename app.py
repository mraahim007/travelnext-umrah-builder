...
# HOTELS LISTS BY CITY
cities_list = ["-- Select City --", "Makkah Al-Mukarramah", "Al-Madinah Al-Munawwarah", "Jeddah"]
...
with col_s1:
    ...
    nights_1 = st.number_input("Nights in City 1:", min_value=0, value=0, step=1, key="c1_nights")
with col_s2:
...
with col_s3:
    orig_1 = st.number_input("Original Cost 1 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c1_orig") or 0.0
    sell_1 = st.number_input("Selling Price 1 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c1_sell") or 0.0
...
if city_1 != "-- Select City --" and nights_1 > 0:
    ...
    with col_s4:
        ...
        nights_2 = st.number_input("Nights in City 2:", min_value=0, value=0, step=1, key="c2_nights")
    with col_s5:
    ...
    with col_s6:
        orig_2 = st.number_input("Original Cost 2 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c2_orig") or 0.0
        sell_2 = st.number_input("Selling Price 2 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c2_sell") or 0.0
...
if city_2 != "-- Select City --" and nights_2 > 0:
    ...
    with col_s7:
        ...
        nights_3 = st.number_input("Nights in City 3:", min_value=0, value=0, step=1, key="c3_nights")
    with col_s8:
    ...
    with col_s9:
        orig_3 = st.number_input("Original Cost 3 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c3_orig") or 0.0
        sell_3 = st.number_input("Selling Price 3 (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="c3_sell") or 0.0
...
with col15:
    ...
    arr_orig = st.number_input("Arrival Original Cost (PKR):", min_value=0.0, value=None, step=500.0, format="%.2f", key="arr_o") or 0.0
    arr_sell = st.number_input("Arrival Selling Price (PKR):", min_value=0.0, value=None, step=500.0, format="%.2f", key="arr_s") or 0.0
    ...
    inter_orig = st.number_input("Inter-City Original Cost (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="inter_o") or 0.0
    inter_sell = st.number_input("Inter-City Selling Price (PKR):", min_value=0.0, value=None, step=1000.0, format="%.2f", key="inter_s") or 0.0
...
with col16:
    ...
    dep_orig = st.number_input("Departure Original Cost (PKR):", min_value=0.0, value=None, step=500.0, format="%.2f", key="dep_o") or 0.0
    dep_sell = st.number_input("Departure Selling Price (PKR):", min_value=0.0, value=None, step=500.0, format="%.2f", key="dep_s") or 0.0
...
with col17:
    visa_air_orig = st.number_input("Total Visa + Airfare Original Cost (PKR):", min_value=0.0, value=None, step=10000.0, format="%.2f", key="va_orig") or 0.0
with col18:
    visa_air_sell = st.number_input("Total Visa + Airfare Selling Price to Customer (PKR):", min_value=0.0, value=None, step=10000.0, format="%.2f", key="va_sell") or 0.0
...
if st.button("Generate Shareable Quotation 📄", type="primary", key="btn_gen_quotation"):
    ...
    **Trip Start Date:** {trip_start_date.strftime('%d %b %Y')} | **Total Duration:** {total_stay_nights} Nights | **Airline:** {cust_airline if cust_airline != '-- Select Airline --' else 'N/A'}
    ...
    if city_3 != "-- Select City --" and nights_3 > 0:
