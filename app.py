...
st.info(f"💡 Total Stays Duration: **{total_stay_nights} Nights** | Hotel Profit: **PKR {hotels_total_profit:,.2f}** | Transport Profit: **PKR {total_transport_profit:,.2f}**")
...
if st.button("Show Internal Profit Sheet 📈", key="btn_profit_sheet"):
    ...
    - **City Transports Total Profit:** PKR {total_transport_profit:,.2f} *(Orig: {total_transport_orig:,.2f} | Sell: {total_transport_sell:,.2f})*
