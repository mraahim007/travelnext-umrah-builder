...
# ================= STEP 8: FINAL PROFESSIONAL QUOTATION PREVIEW =================
    ...
    c_first = st.session_state.get("c_first_name", "").strip()
    c_last = st.session_state.get("c_last_name", "").strip()
    full_client_name = f"{c_first} {c_last}".strip() if (c_first or c_last) else "Valued Customer"
    
    c_pass = st.session_state.get("c_passport", "").strip()
    c_pass_display = c_pass if c_pass else "N/A"
...
_Thanks for choosing TravelNext. Aao Madiney Chalen!_"""
    ...
    <div class="invoice-box">
        ...
        <table class="details-table">
            ...
            <tr>
                <td><b>Passport #:</b> {c_pass_display}</td>
