...
# 3. FLIGHT & DYNAMIC ROUTE BUILDER
st.subheader("✈️ Step 3: Flight & Flexible Route & Itinerary Flow")
...
with col3:
    ...
    cust_landing = st.selectbox("Arrival Airport (Landing City):", ["-- Select Airport --", "Jeddah Airport (JED) - JED", "Madinah Airport (MED) - MED"], key="c_land")
with col4:
    route_pattern = st.selectbox("Select Travel Flow / Route Pattern:", [
        "-- Select Route Pattern --",
        "Classic: Jeddah -> Makkah -> Madinah -> Jeddah",
        "Madinah First: Madinah -> Makkah -> Jeddah",
        "Direct Madinah Return: Madinah -> Makkah -> Madinah",
        "Multi-City / Double Entry (e.g. Jeddah -> Madinah -> Makkah -> Jeddah)",
        "➕ Custom Multi-City Route"
    ], key="c_route_pattern")

# Dynamic City Stay Configuration
st.write("---")
st.subheader("🏨 Step 4 & 5: Flexible Multi-City Stays & Hotel Selections")
st.markdown("Configure your hotel stays dynamically based on your chosen route flow:")
...
# Stay Leg 1
st.markdown("### 🧳 Stay Leg 1")
col_s1, col_s2, col_s3 = st.columns(3)
with col_s1:
    city_1 = st.selectbox("City 1:", ["-- Select City --", "Makkah Al-Mukarramah", "Al-Madinah Al-Munawwarah"], key="c1_city")
...
with col_s2:
    ...
    hotel_1 = st.selectbox("Hotel 1:", makkah_hotels_list if "Makkah" in str(city_1) else madinah_hotels_list, key="c1_hotel")
with col_s3:
...
# Stay Leg 2
st.markdown("### 🧳 Stay Leg 2")
col_s4, col_s5, col_s6 = st.columns(3)
with col_s4:
    city_2 = st.selectbox("City 2:", ["-- Select City --", "Makkah Al-Mukarramah", "Al-Madinah Al-Munawwarah"], key="c2_city")
...
with col_s5:
    ...
    hotel_2 = st.selectbox("Hotel 2:", makkah_hotels_list if "Makkah" in str(city_2) else madinah_hotels_list, key="c2_hotel")
with col_s6:
...
# Optional Stay Leg 3
with st.expander("➕ Add Optional Stay Leg 3 (For Multi-City / Return Visits)"):
    col_s7, col_s8, col_s9 = st.columns(3)
    with col_s7:
        city_3 = st.selectbox("City 3:", ["-- None --", "Makkah Al-Mukarramah", "Al-Madinah Al-Munawwarah"], key="c3_city")
    ...
    with col_s8:
        ...
        hotel_3 = st.selectbox("Hotel 3:", makkah_hotels_list if "Makkah" in str(city_3) else madinah_hotels_list, key="c3_hotel")
    with col_s9:
...
if 'c3_city' not in st.session_state or st.session_state.c3_city == "-- None --":
    city_3 = "-- None --"
    nights_3 = 0
    orig_3 = 0.0
    sell_3 = 0.0
...
# 7. ARRIVAL, DEPARTURE & INTER-CITY TRANSPORT
st.subheader("🚗 Step 7: Airport Transfers & Inter-City Transport")
...
# 8. VISA & AIRFARE WITH PROFIT BREAKDOWN
st.subheader("🎫 Step 8: Visa + Airfare (Original vs Selling)")
...
# 9. CUSTOMER QUOTATION
st.subheader("📄 Step 9: Official Customer Quotation")
if st.button("Generate Shareable Quotation 📄", type="primary", key="btn_gen_quotation"):
    st.success("Quotation Ready with Flexible Itinerary Schedule!")
...
# 10. AGENCY PROFIT DASHBOARD
st.subheader("📊 Step 10: Internal Agency Profit & Cost Breakdown")
