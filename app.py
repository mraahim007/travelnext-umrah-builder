...
# CITIES, HOTELS, & VEHICLES LISTS (Updated with Madinah Airport)
cities_list = [
    "-- Select City / Stop --", 
...
*🏨 Itinerary:*"""
    ...
    if city_1 != "-- Select City / Stop --":
        ...
        if not is_ap1:
            ...
            st.markdown(f"- **Leg 1 ({city_1}):** | *Transport:* {trans_1}")
            share_text += f"\n- Leg 1 ({city_1})"
    ...
    if city_2 != "-- Select City / Stop --":
        ...
        if not is_ap2:
            ...
            st.markdown(f"- **Leg 2 ({city_2}):** | *Transport:* {trans_2}")
            share_text += f"\n- Leg 2 ({city_2})"
    ...
    if city_3 != "-- Select City / Stop --":
        ...
        if not is_ap3:
            ...
            st.markdown(f"- **Leg 3 ({city_3}):** | *Transport:* {trans_3}")
            share_text += f"\n- Leg 3 ({city_3})"
