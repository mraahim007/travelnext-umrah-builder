...
# 7. OFFICIAL CUSTOMER QUOTATION (100% Pure Native Markdown - Zero HTML Errors)
...
if st.button("Generate Quotation 📋", key="btn_gen_quotation"):
    ...
    if city_1 != "-- Select City --":
        ...
        if not is_j1:
            ...
            st.markdown(f"  * *Duration:* {nights_1} Nights ({d1.strftime('%d %b')} - {d2.strftime('%d %b %Y')}) | *Beds:* {num_beds_1} ({bed_type_1}) | *Meal:* {meal_plan_1} | *Transport:* {trans_1}")
        else:
    ...
    if city_2 != "-- Select City --":
        ...
        if not is_j2:
            ...
            st.markdown(f"  * *Duration:* {nights_2} Nights ({d2.strftime('%d %b')} - {d3.strftime('%d %b %Y')}) | *Beds:* {num_beds_2} ({bed_type_2}) | *Meal:* {meal_plan_2} | *Transport:* {trans_2}")
        else:
    ...
    if city_3 != "-- Select City --":
        ...
        if not is_j3:
            ...
            st.markdown(f"  * *Duration:* {nights_3} Nights ({d3.strftime('%d %b')} - {d4.strftime('%d %b %Y')}) | *Beds:* {num_beds_3} ({bed_type_3}) | *Meal:* {meal_plan_3} | *Transport:* {trans_3}")
        else:
