...
if "va_cost_pp_pkr" not in st.session_state: st.session_state.va_cost_pp_pkr = 0.0
if "va_sell_pp_pkr" not in st.session_state: st.session_state.va_sell_pp_pkr = 0.0
if "va_cost_pp_sar" not in st.session_state: st.session_state.va_cost_pp_sar = 0.0
if "va_sell_pp_sar" not in st.session_state: st.session_state.va_sell_pp_sar = 0.0
...
if "z_makkah_cost_pkr" not in st.session_state: st.session_state.z_makkah_cost_pkr = 0.0
if "z_makkah_sell_pkr" not in st.session_state: st.session_state.z_makkah_sell_pkr = 0.0
if "z_makkah_cost_sar" not in st.session_state: st.session_state.z_makkah_cost_sar = 0.0
if "z_makkah_sell_sar" not in st.session_state: st.session_state.z_makkah_sell_sar = 0.0
...
if "z_madinah_cost_pkr" not in st.session_state: st.session_state.z_madinah_cost_pkr = 0.0
if "z_madinah_sell_pkr" not in st.session_state: st.session_state.z_madinah_sell_pkr = 0.0
if "z_madinah_cost_sar" not in st.session_state: st.session_state.z_madinah_cost_sar = 0.0
if "z_madinah_sell_sar" not in st.session_state: st.session_state.z_madinah_sell_sar = 0.0
...
for i in range(10):
    ...
    if f"leg_cost_pn_pkr_{i}" not in st.session_state: st.session_state[f"leg_cost_pn_pkr_{i}"] = 0.0
    if f"leg_sell_pn_pkr_{i}" not in st.session_state: st.session_state[f"leg_sell_pn_pkr_{i}"] = 0.0
    if f"leg_cost_pn_sar_{i}" not in st.session_state: st.session_state[f"leg_cost_pn_sar_{i}"] = 0.0
    if f"leg_sell_pn_sar_{i}" not in st.session_state: st.session_state[f"leg_sell_pn_sar_{i}"] = 0.0
    ...
    if f"leg_t_cost_pkr_{i}" not in st.session_state: st.session_state[f"leg_t_cost_pkr_{i}"] = 0.0
    if f"leg_t_sell_pkr_{i}" not in st.session_state: st.session_state[f"leg_t_sell_pkr_{i}"] = 0.0
    if f"leg_t_cost_sar_{i}" not in st.session_state: st.session_state[f"leg_t_cost_sar_{i}"] = 0.0
    if f"leg_t_sell_sar_{i}" not in st.session_state: st.session_state[f"leg_t_sell_sar_{i}"] = 0.0
